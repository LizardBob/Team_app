...
class Users(models.Model):
    ...
    user_mail = models.CharField(db_column='User_mail', max_length=320, blank=True, null=True)  # Field name made lowercase.
    ...
    user_surname = models.CharField(db_column='User_surname', max_length=45, blank=True, null=True)  # Field name made lowercase.
    idteam = models.ForeignKey(Teams, on_delete= models.CASCADE,db_column='idTeam')  # Field name made lowercase.
